...
class XPathScanner(Scanner):
    patterns = [
        ...
        (
            ...
            re.compile("processing-instruction\\s*\\("),
        ),
        ("r'\\,'", re.compile("\\,")),
        ("r'\\.'", re.compile("\\.")),
        ("r'\\$'", re.compile("\\$")),
        ...
        (
            "REVERSE_AXIS_NAME",
            re.compile("parent|preceding-sibling|preceding|ancestor-or-self|ancestor"),
        ),
...
class XPath(Parser):
    ...
    def AndExpr(self):
        ...
        Expr = EqualityExpr
        while (
            self._peek("r'and'", "r'or'", "END", "r'\\]'", "r'\\)'", "r'\\,'")
            == "r'and'"
        ):
            self._scan("r'and'")
            EqualityExpr = self.EqualityExpr()
    ...
    def PrimaryExpr(self):
        _token_ = self._peek(
            "r'\\('", "r'\\$'", "r'\\.'", "FUNCNAME", "NUMBER", "DQUOTE", "SQUOTE"
        )
