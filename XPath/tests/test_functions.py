...
"""
    ...
    def test_namespace_uri(self):
        ...
        self.assertEqual(result, 'http://www.example.com/a')
    ...
    def test_name(self):
        ...
        self.assertEqual(result, 'b:item')
...
"""
    ...
    def test_string_cdata_child(self):
        ...
        self.assertEqual(result, "fooone<two>threebar")
...
"""
    ...
    def test_lang_text_jp(self):
        result = xpath.find(
            ...
            self.doc)
        self.assertEqual(result, 'Nihongo')
